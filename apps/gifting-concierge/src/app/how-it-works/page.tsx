					...
					<div className="relative z-20 py-10">
						<div className="mx-auto flex max-w-screen-xl flex-col gap-8 px-4 md:px-8">
							<div className="mx-auto max-w-5xl text-center">
								<h2 className="text-5xl font-bold tracking-tight text-balance text-foreground sm:text-6xl">
									Send gifts discreetly and easily
								</h2>
								<p className="mt-6 text-xl leading-8 text-foreground/80 text-pretty">
