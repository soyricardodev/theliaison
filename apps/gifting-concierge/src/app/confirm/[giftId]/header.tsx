    ...
    <header className="w-full mx-auto mt-4 flex items-center justify-between">
      ...
      <ul className="flex items-center justify-center gap-2">
        <li className="mr-4 hidden sm:inline-flex">
          <a href="https://instagram.com" target="_blank" className="flex items-center justify-center">
            <InstagramIcon className="size-6 text-white hover:text-white/90 transition-colors" />
          </a>
        </li>
        <li>
          <Link href="/register" className="text-sm text-black rounded-md hover:bg-white/80 transition-colors py-2 px-3 bg-white">
            Get Started 
          </Link>
        </li>
      </ul>
