...
export default function Pricing({ user, products, subscription }: Props) {
	...
	return (
		<section id="pricing">
			<div className="mx-auto my-14 flex max-w-screen-2xl flex-col gap-8 px-4 py-14 md:px-8">
				<div className="mx-auto max-w-5xl text-center">
					<h4 className="text-xl font-bold tracking-tight text-black dark:text-white">
						Pricing
					</h4>

					<h2 className="font-heading text-5xl font-black tracking-tight text-black dark:text-white sm:text-6xl">
						Simple pricing for everyone.
					</h2>

					<p className="text-default-800 mx-auto mt-6 max-w-[600px] text-pretty text-xl leading-8">
				...
				<div className="mx-auto mt-16 flex w-full flex-col items-center justify-center gap-8 lg:flex-row">
