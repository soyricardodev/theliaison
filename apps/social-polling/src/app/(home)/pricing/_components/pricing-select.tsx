		...
		<div className="flex items-center justify-start gap-3 tabular-nums">
			<span className="w-full max-w-[12px]">
				<svg
					...
					className="h-4 w-4 rounded-full bg-[#58F0D4] text-white"
				>
					<path
		...
		>
			...
			>
				...
				<Button
					onClick={onClick}
					className={cn(
						"inline-flex h-10 w-full shrink-0 items-center justify-center whitespace-nowrap rounded-full border border-input bg-background px-3 py-2 text-sm font-medium text-black shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
						disabled &&
							"inline-flex h-10 shrink-0 items-center justify-center whitespace-nowrap rounded-full border border-input bg-background px-3 py-2 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-[#F2F2F2] disabled:text-[#8F8F8F] disabled:opacity-100",
						featured &&
							"inline-flex h-10 shrink-0 items-center justify-center whitespace-nowrap rounded-full border-none bg-primary px-3 py-2 text-sm font-medium text-[#5EFFE2] shadow transition-colors hover:bg-primary/90 hover:text-[#5EFFE2] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-[#F2F2F2] disabled:text-[#8F8F8F] disabled:opacity-100",
					)}
					disabled={disabled}
				>
