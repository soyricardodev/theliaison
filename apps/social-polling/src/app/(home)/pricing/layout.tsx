			...
			<div className="w-full">
				<div className="mx-auto flex max-w-[1160px] flex-col gap-8 px-5 pt-10 md:gap-12 md:pt-16">
					<div className="grid justify-items-center gap-2 md:gap-4">
						...
						<p className="max-w-md text-pretty text-center text-sm text-[#666666] md:max-w-xl md:text-base">
				...
				{/* FAQ */}
				<div className="my-16 flex flex-col p-5 md:gap-4 md:px-6 md:py-[60px]">
					...
					<div className="mx-auto mt-20 w-full max-w-[448px] md:max-w-[920px]">
						<FAQ />
					</div>
				</div>
				...
				<div className="bg-black px-5 pb-14 pt-8 text-white md:px-6 md:py-[60px]">
					<div className="mx-auto flex max-w-[448px] flex-col gap-8 md:max-w-[920px] md:flex-row md:px-6">
						...
						<div className="flex flex-col gap-2 md:w-[234px]">
							<Link
								href="/explore"
								className="inline-flex h-10 w-full shrink-0 items-center justify-center gap-x-2 whitespace-nowrap rounded-full border border-white bg-transparent px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 md:max-w-[234px]"
							>
								Check Polls
							</Link>
							<Link
								href="/contact"
								className="inline-flex h-10 w-full shrink-0 items-center justify-center gap-x-2 whitespace-nowrap rounded-full bg-secondary px-8 text-sm font-medium text-secondary-foreground shadow-sm transition-colors hover:bg-secondary/80 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 md:max-w-[234px]"
							>
								Contact Us
							</Link>
						</div>
