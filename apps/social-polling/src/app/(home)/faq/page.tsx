      ...
      <div>
        <div className="py-16">
          <div className="mx-auto max-w-screen-md px-4 sm:px-6">
            ...
            <p className="text-default-800 mt-5 text-pretty text-center text-lg">
        ...
        <div className="mx-auto flex max-w-screen-md flex-col items-center px-4 py-10 sm:px-6 sm:pt-20 lg:px-8">
          <article className="prose-headings:font-heading prose prose-headings:relative prose-headings:scroll-mt-20 prose-headings:font-semibold text-default-900 max-w-none transition-all">
            {faqs.map((faq) => (
