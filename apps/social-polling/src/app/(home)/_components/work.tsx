...
export function WorkHeader() {
  return (
    <div className="mx-auto mt-24 max-w-screen-2xl px-6 sm:mt-32 lg:mt-40 lg:px-8">
  ...
  return (
    <>
      ...
      <section className="mx-auto mb-28 mt-16 max-w-screen-2xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="mt-16 grid w-full grid-cols-1 place-items-center items-center justify-center gap-8 lg:grid-cols-3">
            <ProcessWork1 />
            <ProcessWork2 />
            <ProcessWork3 />
          </div>
