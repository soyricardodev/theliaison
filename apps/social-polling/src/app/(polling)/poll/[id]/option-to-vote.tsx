...
export function OptionToVote({
  ...
  const optionVotedByUser = optionVotedId === option.id;
    ...
    <>
      ...
      >
        <button
          type="button"
          className={cn(
            "bg-content2 hover:bg-content3 border-default-400 rounded-lg border px-5 py-8 transition-colors",
