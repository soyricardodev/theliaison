		...
		<div ref={headerParentRef} className="max-h-[450px] overflow-y-scroll">
			<div className="h-[100vh]">
				<header className="mx-auto flex max-w-5xl items-center justify-between bg-transparent px-10 py-7 dark:bg-transparent">
					...
					<Link
						href="/auth/signin"
						className="relative hidden w-fit items-center justify-center gap-x-1.5 overflow-hidden rounded-full bg-neutral-900 px-3 py-1.5 text-white outline-none dark:bg-white dark:text-black lg:inline-flex"
					>
						Get Started
					</Link>
					{/* </div> */}
